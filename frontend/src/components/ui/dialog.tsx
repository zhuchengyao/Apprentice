...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-foreground/15 duration-150 supports-backdrop-filter:backdrop-blur-sm",
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "gap-4 rounded-2xl bg-popover p-6 text-sm text-popover-foreground",
          "ring-1 ring-border/80 shadow-editorial-lg duration-150 outline-none",
          "sm:max-w-md",
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6 -mb-6 mt-2 flex flex-col-reverse gap-2 rounded-b-2xl border-t border-border/60 bg-subtle/60 px-6 py-4",
