...
export function BookCard({ book, index, selected, onToggleSelect }: BookCardProps) {
    ...
    >
      ...
      {selectable && (
        <button
          ...
          className={cn(
            "absolute top-3 left-3 z-10 flex h-5 w-5 items-center justify-center rounded border-2 transition-colors",
            selected
              ? "border-primary bg-primary text-primary-foreground"
              : "border-muted-foreground/40 bg-background/80 hover:border-foreground",
          )}
        >
